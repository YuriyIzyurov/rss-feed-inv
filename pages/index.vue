  ...
  <div class="content">
    <header class="header">
      <div class="header__menu">
        ...
        <div class="header__refresh-button-wrapper">
          <button ref="refreshButton" class="header__refresh-button" @click="handleRefresh">
...
import {animateButton} from "~/utils/animation";
...
function handleRefresh() {
  ...
  refreshFilter()
  animateButton(refreshButton.value)
}
